...
const CourseDetails = () => {
  ...
  return (
    <Container>
      <ReactToPrint
        trigger={() => (
          <button className="bg-blue-700 mt-6 py-2 px-3 rounded dark:text-white text-white">
            Download PDF
          </button>
        )}
      ...
      />
      <div
        className="my-16 mt-6 bg-white dark:bg-gray-800 py-8  px-10 rounded-md shadow-md border dark:border-none"
        ref={pdfRef}
      >
        ...
        <div className="max-w-3xl mx-auto">
          <img src={course_imgUrl} alt={course_title} className="rounded-md" />
        </div>
